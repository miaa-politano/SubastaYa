...
INSERT INTO "AUCTION" ("ID", "SELLER_ID", "CATEGORY_ID", "TITLE", "DESCRIPTION", "STARTING_PRICE", "CURRENT_PRICE", "MIN_INCREMENT", "START_DATE_UTC", "END_DATE_UTC", "STATUS", "CURRENT_WINNER_ID") VALUES
                                                                                                                                                                                                          (1, 1, 1, 'Notebook Gamer de Prueba', 'Test Concurrencia', 100000.00, 120000.00, 5000.00, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP + INTERVAL '30 minutes', 'ACTIVE', 2),
                                                                                                                                                                                                          (2, 1, 1, 'Subasta Critica', 'Test Anti-sniping', 50000.00, 50000.00, 2000.00, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP + INTERVAL '45 seconds', 'ACTIVE', NULL);
